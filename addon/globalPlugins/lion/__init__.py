...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
	...
	def __init__(self):
		...
		# OCR state cache limits (memory leak prevention)
	...
	def script_ReadLiveOcr(self, gesture):
		...
		# Wait outside lock for thread to finish
		if self._ocrThread and self._ocrThread.is_alive():
	...
	def _handleOcrResult(self, result, key, configuredThreshold):
		...
		"""
		# Periodic cache cleanup (memory leak prevention)
		...
		# Speak outside of lock using thread-safe queueHandler
		if shouldSpeak:
